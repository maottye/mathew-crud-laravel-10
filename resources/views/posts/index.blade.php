                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="{{ route('posts.create') }}"
                            class="btn btn-md btn-success mb-3 col font-weight-bold"><i
                                class="bi bi-plus-circle pr-2"></i>TAMBAH POST</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                ...
                                                <div class="btn-show mb-2">
                                                    <a href="{{ route('posts.show', $post->id) }}"
                                                        class="btn btn-sm btn-dark btn-block">SHOW</a>
                                                </div>
